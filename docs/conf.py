# -*- coding: utf-8 -*-
#
# pytest-typehints documentation build configuration file, created by
...
project = u'pytest-typehints'
copyright = u'2015, Edward Dunn Ekelund'
author = u'Edward Dunn Ekelund'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-typehints Documentation',
     [author], 1)
]
